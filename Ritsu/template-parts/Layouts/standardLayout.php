...
<div class="main-content-container">
		<div class="container">
			<div class="row">
                ...
                <div class="<?php if($sideBarStatu !== true): echo "standard-fullwidth" ; else : echo "col-2-3 group" ; endif; ?>">
						...
						<div class="post big-post">
                            <div class="post-img">
                                <a href="<?php the_permalink(); ?>">
                                    <img src="<?php echo get_the_post_thumbnail_url(get_the_ID()); ?>" class="standard_big_wp" alt="big post image">
                                </a>
                            </div>
                            <div class="post-text">
                                ...
                                <h1><a href="<?php the_permalink(); ?>" class="post-title big"><?php echo wp_trim_words(get_the_title(), 8);?></a></h1>
